...
class MaxSSHConnections(object):
    ...
    def __init__(self, device, **kwargs):
        ...
        self.dev = Device(host=device, user=username, passwd=password, normalize=True)
...
def main():
    ...
    # Copy the playbook arguments into local variables
    ...
    module.exit_json(changed=False, results=find_max.results, rate_limit=find_max.results['rate_limit'], connection_limit=find_max.results['connection_limit'])
